...
<title>Kelola Data Beasiswa</title>
...
<div class="main_wrapper">
    ...
    <div class="menubar">
		...
		<li><a href="homeadmin.php">HOME</a></li>
            ...
            <li><a href="kelolabiodata.php">BIODATA</a></li>
            <li><a href="kelolabeasiswa.php">PROGRAM BEASISWA</a>
            	<!--<ul>
                	<li><a href="#"> Beasiswa Al Azhar</a></li>
                    <li><a href="#"> Beasiswa </a></li>
                 </ul></li>-->
            <li><a href="kelolauu.php">UU PERLINDUNGAN ANAK</a></li>
				...
				function halaman_utama()
                {
					...
					if($rs=mysql_query($sql)){
						...
						while (is_array($row=mysql_fetch_assoc($rs))){
							...
							<td>$row[ket_beasiswa]</td>
							<td>$row[link_beasiswa]</td>
							<td>$row[logo_beasiswa]</td>
							<td>
								<a href=edit.php?nama_beasiswa=$row[nama_beasiswa]>Edit</a>&nbsp;
								<a href=hapus.php?nama_beasiswa=$row[nama_beasiswa]>Hapus</a>
							</td>
							</tr>");					
						}
							echo("</table>
								  <br/><a href=insert_beasiswa.php>Tambah Data</a>&nbsp;
								  </center>");
						}
